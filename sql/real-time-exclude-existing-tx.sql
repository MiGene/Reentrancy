...
SET victim_address = '0xE446158503d0F5c70579FCCE774C00E8Db544559'; #EDIT
SET attack_datetime = "2024-08-23T17:36:59"; #EDIT
SET victim_create_date = "2021-04-29"; #EDIT
...
no_dup_transaction_involved AS(
    SELECT transaction_involved.*
    FROM transaction_involved
    LEFT JOIN `` as exist_transactions
        ON transaction_involved.transaction_hash = exist_transactions.transaction_hash
    WHERE exist_transactions.transaction_hash IS NULL;
),
...
transaction_info AS(
  ...
  JOIN no_dup_transaction_involved ON no_dup_transaction_involved.transaction_hash = tx_db.hash 
...
traces AS (
  ...
  where tc.transaction_hash in (
    ...
    from no_dup_transaction_involved
